...
import com.zeoflow.password.strength.matching.match.DateMatch;
import com.zeoflow.password.strength.matching.match.DictionaryMatch;
import com.zeoflow.password.strength.matching.match.Match;
import com.zeoflow.password.strength.matching.match.RepeatMatch;
import com.zeoflow.password.strength.matching.match.SequenceMatch;
import com.zeoflow.password.strength.matching.match.SpacialMatch;
...
public class FeedbackUtil
{
    ...
    private static Feedback getMatchFeedback(final Result result, final Match match)
    {
        ...
        if (match instanceof RepeatMatch && ((RepeatMatch) match).getRepeatingCharacters().length() == 1)
        {
        ...
        {
            if (((SpacialMatch) match).getTurns() > 0)
            {
        ...
        {
            DictionaryMatch dictionaryMatch = (DictionaryMatch) match;
