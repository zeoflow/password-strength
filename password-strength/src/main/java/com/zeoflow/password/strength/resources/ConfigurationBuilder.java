...
import com.zeoflow.password.strength.matching.DateMatcher;
import com.zeoflow.password.strength.matching.DictionaryMatcher;
import com.zeoflow.password.strength.matching.PasswordMatcher;
import com.zeoflow.password.strength.matching.RepeatMatcher;
import com.zeoflow.password.strength.matching.SeparatorMatcher;
import com.zeoflow.password.strength.matching.SequenceMatcher;
import com.zeoflow.password.strength.matching.SpacialMatcher;
import com.zeoflow.password.strength.matching.YearMatcher;
...
public class ConfigurationBuilder
{
    ...
    /**
     * @return Includes all standard password matchers included with PasswordChecker.
     */
    ...
    /**
     * @return Returns all the dictionaries included with PasswordChecker.
     ...
     */
    public static List<Dictionary> getDefaultDictionaries(Context context)
    {
        defaultDictionaries.add(new Dictionary("passwords", DictionaryUtil.loadRankedDictionary(DictionaryUtil.passwords, context), false));
        defaultDictionaries.add(new Dictionary("male_names", DictionaryUtil.loadRankedDictionary(DictionaryUtil.male_names, context), false));
        defaultDictionaries.add(new Dictionary("female_names", DictionaryUtil.loadRankedDictionary(DictionaryUtil.female_names, context), false));
        defaultDictionaries.add(new Dictionary("surnames", DictionaryUtil.loadRankedDictionary(DictionaryUtil.surnames, context), false));
        defaultDictionaries.add(new Dictionary("english", DictionaryUtil.loadRankedDictionary(DictionaryUtil.english, context), false));
        defaultDictionaries.add(new Dictionary("eff_large", DictionaryUtil.loadUnrankedDictionary(DictionaryUtil.eff_large, context), false));
    ...
    public ConfigurationBuilder setMinimumEntropy(BigDecimal seconds_to_crack, String guess_type)
    {
        ...
        minimumEntropy = PasswordChecker.getEntropyFromGuesses(guesses);
        return this;
    }
    ...
    public Configuration createConfiguration(Context context)
    {
        ...
        {
            dictionaries = getDefaultDictionaries(context);
        }
